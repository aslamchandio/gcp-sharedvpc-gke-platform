###############################################################################
# prod/variables.tf
# Root inputs for the prod environment (driven by terraform.tfvars).
###############################################################################
...
variable "environment_name" {
  description = "Environment short name, used in the name + common_tags (e.g. \"prod\")."
  type        = string
}
...
variable "cluster_name" {
  description = "Cluster name SUFFIX; combined with business_division + environment_name into gke_cluster_name (e.g. \"standard\" -> \"it-prod-standard\")."
  type        = string
}

variable "regional" {
  description = "Regional (3-zone HA) vs zonal control plane. Prod uses regional."
  type        = bool
}
